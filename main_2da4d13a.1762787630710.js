...
const list_CustomStyle = styled_components_browser_esm/* default */.Ay.div`
	...
	.tabs_list_conter {
		...
		span {
			display: inline-block;
			font-size: 12px;
			font-family: SFProTextLight !important;
		}
		i {
			display: flex;
			align-items: center;
...
function List(_ref) {
  ...
  // 质押天数1天
  // 86400
  item.stakeIndex === "0" ? /*#__PURE__*/react.createElement("em", null, currentDate > item.stakeTime * 1 + 1 * 60 * 60 ? /*#__PURE__*/react.createElement("em", {
    onClick: () => handleRed(item.index)
  }, t('Red')) : /*#__PURE__*/react.createElement("i", null, t('Pending'))) :
  // 质押天数15天
  item.stakeIndex === "1" ? /*#__PURE__*/react.createElement("em", null, currentDate > item.stakeTime * 1 + 15 * 60 * 60 ? /*#__PURE__*/react.createElement("em", {
    onClick: () => handleRed(item.index)
  }, t('Red')) : /*#__PURE__*/react.createElement("i", null, t('Pending'))) :
  // 质押天数30天
  item.stakeIndex === "2" ? /*#__PURE__*/react.createElement("em", null, currentDate > item.stakeTime * 1 + 30 * 60 * 60 ? /*#__PURE__*/react.createElement("em", {
    onClick: () => handleRed(item.index)
  }, t('Red')) : /*#__PURE__*/react.createElement("i", null, t('Pending'))) :
  // 质押天数5天
  item.stakeIndex === "3" ? /*#__PURE__*/react.createElement("em", null, currentDate > item.stakeTime * 1 + 5 * 60 * 60 ? /*#__PURE__*/react.createElement("em", {
    onClick: () => handleRed(item.index)
...
const pool_zh_bg_namespaceObject = __webpack_require__.p + "45d2d60217cdc12dee39.png";
;// ./src/assets/images/pool_en_bg.png
const pool_en_bg_namespaceObject = __webpack_require__.p + "1034796709b506d6483d.png";
...
const banner1_en_namespaceObject = __webpack_require__.p + "8b80c5eaa565a38f2112.png";
;// ./src/assets/images/banner1_zh.png
const banner1_zh_namespaceObject = __webpack_require__.p + "904cf655df7dd39be45b.png";
