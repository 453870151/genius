...
const addressStakingContract = {
  56: '',
  97: '0x5F6F91ecb10A27782056025c253d868d70Eb8EaF'
};
...
function List(_ref) {
  ...
  return /*#__PURE__*/react.createElement(list_CustomStyle, null, contextHolder, /*#__PURE__*/react.createElement("div", {
    ...
    className: "conts_wid4"
  }, toFixedFloor(item.profitBig, 6)), /*#__PURE__*/react.createElement("span", {
    className: "conts_wid5"
  },
  // 质押天数1天
  ...
  const handleIsBindReferral = async () => {
    try {
      ...
      if (address && contract) {
        ...
        // 邀请人地址是否质押
        if (invitation) {
          let isInvitationReferral = await contract.methods.isBindReferral(invitation).call();
...
/******/ 	var __webpack_exports__ = __webpack_require__.O(undefined, [92], () => (__webpack_require__(9199)))
