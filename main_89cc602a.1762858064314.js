...
const addressStakingContract = {
  56: '',
  97: '0x940807EbBbE8928287F7A52DD8462cDD0C41cea3'
};
...
const logo_namespaceObject = __webpack_require__.p + "5968b419f4f2dda6b32f.png";
...
function List(_ref) {
  ...
  // 质押天数1天
  // 86400
  item.stakeIndex === "0" ? /*#__PURE__*/react.createElement("em", null, currentDate > item.stakeTime * 1 + 1 * 60 * 60 ? /*#__PURE__*/react.createElement("i", {
    onClick: () => handleRed(item.index)
  }, t('Red')) : /*#__PURE__*/react.createElement("i", null, t('Pending'))) :
  // 质押天数15天
  item.stakeIndex === "1" ? /*#__PURE__*/react.createElement("em", null, currentDate > item.stakeTime * 1 + 15 * 60 * 60 ? /*#__PURE__*/react.createElement("i", {
    onClick: () => handleRed(item.index)
  }, t('Red')) : /*#__PURE__*/react.createElement("i", null, t('Pending'))) :
  // 质押天数30天
  item.stakeIndex === "2" ? /*#__PURE__*/react.createElement("em", null, currentDate > item.stakeTime * 1 + 30 * 60 * 60 ? /*#__PURE__*/react.createElement("i", {
    onClick: () => handleRed(item.index)
  }, t('Red')) : /*#__PURE__*/react.createElement("i", null, t('Pending'))) :
  // 质押天数5天
  item.stakeIndex === "3" ? /*#__PURE__*/react.createElement("em", null, currentDate > item.stakeTime * 1 + 5 * 60 * 60 ? /*#__PURE__*/react.createElement("i", {
    onClick: () => handleRed(item.index)
