...
// EXTERNAL MODULE: ./node_modules/.store/i18next@25.6.0/node_modules/i18next/dist/esm/i18next.js
var i18next = __webpack_require__(305);
...
function AddPollModal(_ref) {
  ...
  (0,react.useEffect)(() => {
    if (inputDay === 1) {
      setInputDayText(1 + t('Days') + t('CI') + " 0.3%");
    } else if (inputDay === 5) {
      setInputDayText(5 + t('Days') + t('CI') + " 1%");
    } else if (inputDay === 15) {
      setInputDayText(15 + t('Days') + t('CI') + " 0.6%");
    } else if (inputDay === 30) {
      setInputDayText(30 + t('Days') + t('CI') + " 1.2%");
    }
  ...
  }, "1", t('Days')), isOpen && /*#__PURE__*/react.createElement("span", {
    className: inputDay === 5 ? 'on' : '',
    onClick: () => handleDayIndex(5, 3)
  }, "5", t('Days')), /*#__PURE__*/react.createElement("span", {
  ...
  }, "30", t('Days'))), Number(allApprove) === 0 || Number(allApprove) < Number(inputNumber) ? /*#__PURE__*/react.createElement("div", {
...
;// ./src/assets/images/buttom_bg.svg
const buttom_bg_namespaceObject = "data:image/svg+xml;base64,";
...
function List(_ref) {
  ...
  return /*#__PURE__*/react.createElement(list_CustomStyle, null, contextHolder, /*#__PURE__*/react.createElement("div", {
    ...
    src: tab_on_namespaceObject,
    alt: ""
  })))), table === 1 && /*#__PURE__*/react.createElement("div", null, /*#__PURE__*/react.createElement("div", {
    ...
    className: "conts_wid2"
  }, formatTimestamp(item.stakeTime * 1000, "MM-DD HH:mm"), /*#__PURE__*/react.createElement("br", null),
  // 质押天数1天
  // 86400
  item.stakeIndex === "0" ? /*#__PURE__*/react.createElement("div", null, /*#__PURE__*/react.createElement(CountdownTimestamp, {
    targetTimestamp: item.stakeTime * 1 + 1 * 60 * 60
  })) :
  // 质押天数15天
  item.stakeIndex === "1" ? /*#__PURE__*/react.createElement("div", null, /*#__PURE__*/react.createElement(CountdownTimestamp, {
    targetTimestamp: item.stakeTime * 1 + 15 * 60 * 60
  })) :
  // 质押天数30天
  item.stakeIndex === "2" ? /*#__PURE__*/react.createElement("div", null, /*#__PURE__*/react.createElement(CountdownTimestamp, {
    targetTimestamp: item.stakeTime * 1 + 30 * 60 * 60
  })) :
  // 质押天数5天
  item.stakeIndex === "3" ? /*#__PURE__*/react.createElement("div", null, /*#__PURE__*/react.createElement(CountdownTimestamp, {
    targetTimestamp: item.stakeTime * 1 + 5 * 60 * 60
  ...
  item.stakeIndex === "3" ? /*#__PURE__*/react.createElement("i", null, currentDate > item.stakeTime * 1 + 5 * 60 * 60 ? /*#__PURE__*/react.createElement("em", {
    ...
    className: "noData"
  }, t('No data available'))), table === 2 && /*#__PURE__*/react.createElement("div", null, /*#__PURE__*/react.createElement("div", {
    className: "tabs_title_conter"
  }, /*#__PURE__*/react.createElement("span", {
    className: "conts_wid1"
  }, t('Index')), /*#__PURE__*/react.createElement("span", {
...
function Comm1() {
  ...
  const [myAssets, setMyAssets] = (0,react.useState)("0.0000");
  const [myPerformance, setMyPerformance] = (0,react.useState)("0.0000");
      ...
      if (address && contract) {
        ...
        for (let i = 0; i < stakeCount; i++) {
          ...
          if (record.status) {
            ...
            // profit = Number(unstakeRewards) - Number(record.amount);
            ...
            // profit = Number(rewardOfSlot) - Number(record.amount);
            profit = new bignumber/* default */.A(rewardOfSlot.toString()).shiftedBy(-18).toString();
          }
          // const profitBig = new BigNumberjs(profit.toString()).shiftedBy(-18).toString();
          records.push({
            ...record,
            index: i,
            // 序号
...
/******/ 	var __webpack_exports__ = __webpack_require__.O(undefined, [92], () => (__webpack_require__(4457)))
